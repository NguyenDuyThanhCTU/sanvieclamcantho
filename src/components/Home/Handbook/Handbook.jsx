      ...
      <div className="grid grid-cols-3 gap-5 cursor-pointer">
        <div className=" p-3 w-[370px] h-[356px] hover:shadow-lg">
          ...
          <p className="truncate font-semibold">
            Trong xã hội hiện đại, công việc ca đêm đang trở thành một lựa chọn
            phổ biến đối với nhiều người. Một số người chọn công việc ca đêm vì
            có lối sống năng động và thích{" "}
          </p>
        </div>
        <div className=" p-3 w-[370px] h-[356px] hover:shadow-lg">
          <img
